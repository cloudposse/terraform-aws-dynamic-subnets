...
| <a name="input_assign_ipv6_address_on_creation"></a> [assign\_ipv6\_address\_on\_creation](#input\_assign\_ipv6\_address\_on\_creation) | Whether to assign ipv6 address for new resource | `bool` | `false` | no |
...
| <a name="input_egress_only_igw_id"></a> [egress\_only\_igw\_id](#input\_egress\_only\_igw\_id) | Egress Only Internet Gateway ID the privete route tables will point to (e.g. `eigw-9c26a123`) | `string` | `""` | no |
