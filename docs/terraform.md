...
| subnet_type_tag_key | Key subnet type tag (e.g. `cpco.io/subnet/type` will mapped to tags `cpco.io/subnet/type=private` and `cpco.io/subnet/type=public`) | string | `cpco.io/subnet/type` | no |
