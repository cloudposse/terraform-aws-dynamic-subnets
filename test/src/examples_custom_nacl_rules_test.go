...
// Test the Terraform module in examples/custom-nacl-rules using Terratest.
func TestExamplesCustomNaclRules(t *testing.T) {
	t.Parallel()
	randID := strings.ToLower(random.UniqueId())
	attributes := []string{randID}

	rootFolder := "../../"
	terraformFolderRelativeToRoot := "examples/custom-nacl-rules"
...
func TestExamplesCustomNaclRulesDisabled(t *testing.T) {
	t.Parallel()
	randID := strings.ToLower(random.UniqueId())
	attributes := []string{randID}
