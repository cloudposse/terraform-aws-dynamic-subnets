...
| <a name="input_nat_instance_ebs_optimized"></a> [nat\_instance\_ebs\_optimized](#input\_nat\_instance\_ebs\_optimized) | Whether the launched NAT EC2 instance will be EBS-optimized | `bool` | `true` | no |
